<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="puertasSalida.aspx.cs" Inherits="Vuelos.puertasSalida" %>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div id="bootstrap-data-table_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:vvuelosConnectionString %>" SelectCommand="sp_getVuelos_salida" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                                </div>
                                                <div>
