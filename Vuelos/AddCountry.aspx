<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddCountry.aspx.cs" Inherits="Vuelos.AddCountry" %>
        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    <h1 class="text-white">Añadir país</h1>
                </div>
            </div>
        </div>
    </section>
                                    ...
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <asp:Label ID="Label3" runat="server" Text=" Consecutivo" for="select" class=" form-control-label"></asp:Label>
                                            </div>
