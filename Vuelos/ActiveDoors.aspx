<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveDoors.aspx.cs" Inherits="Vuelos.Active_doors" %>
            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav"><a href="index.html">Inicio </a><span class="lnr lnr-arrow-right"></span><a href="aeropuertos.html">Aeropuertos</a> <span class="lnr lnr-arrow-right"></span><a href="puertasAeropuerto.html">Puertas</a></p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 cta-right">
                        <asp:Button ID="btn_inicioSesion" class="primary-btn wh" runat="server" Text="Iniciar Sesión" />
                    </div>
                </div>
            </div>
        </section>
