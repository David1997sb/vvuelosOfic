<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bita.aspx.cs" Inherits="Vuelos.bita" %>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12" >
                    <div class="card">                        
                     <div class="card-body">                  
                    <div class="container">
					<h1 class="mb-2">Consulta por fecha en que se modificó <span class="auto-style1">(formato DD/MM/YYYY)</span></h1>
					<div class="row">
                    ...
                    <br />
                    <br />
					<h1 class="mb-2">Consulta por usuario que modificó</h1>					
					<div class="row">
							<div class="col-md-3">							
								<ul class="nav nav-stacked">
                    ...
                    <br />
                    <br />
					<h1 class="mb-2">Consulta por tipo de cambio que se realizó</h1>					
					<div class="row">
							<div class="col-md-3">															
